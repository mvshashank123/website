...
function Mui() {
  ...
  return (
    <Jumbotron fluid className="jumbotron jumbotron-fluid m-0"
    style={{ backgroundColor: "white", width:"98%" }} id="skill">
        ...
        <Grid container spacing={6}>
          <Grid className={classes.grid} item xs={12} sm={12} md={12}>
            <Card className={classes.card}>
              <CardActionArea>
                ...
                />
                <CardContent>
                  <Typography gutterBottom variant="h5" component="h2" className={classes.type}>
                    React useContext
                  </Typography>
          ...
          <Grid item xs={12} sm={6} md={12}>
            <Card className={classes.card}>
              ...
              <CardActions className={classes.cardActions}>
                <Box className={classes.author}>
                  <Avatar src="https://cdn-images-1.medium.com/max/2600/0*Ia89utJJsCLFLUW2" />
                  <Box ml={2}>
                    <Typography variant="subtitle2" component="p">
                      Guy Clemons
                    </Typography>
